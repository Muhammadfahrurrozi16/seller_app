...
/// @nodoc
mixin _$LoginEvent {
  LoginRequestModel get model => throw _privateConstructorUsedError;
  @optionalTypeArgs
...
mixin _$LoginState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(AuthResponModel data) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(AuthResponModel data)? loaded,
...
abstract class _Loaded implements LoginState {
  const factory _Loaded(final AuthResponModel data) = _$LoadedImpl;

  AuthResponModel get data;
  @JsonKey(ignore: true)
  _$$LoadedImplCopyWith<_$LoadedImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
