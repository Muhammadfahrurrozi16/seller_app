...
mixin _$AddImageState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ImageRespon data) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(ImageRespon data)? loaded,
...
abstract class _Loaded implements AddImageState {
  const factory _Loaded(final ImageRespon data) = _$LoadedImpl;

  ImageRespon get data;
  @JsonKey(ignore: true)
  _$$LoadedImplCopyWith<_$LoadedImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
